...
if hostname -I | grep -q "10.186.0"; then
  ...
  REST_GW_URL="http://rest-api-gateway:3000/api"
  RPC_GW_URL="http://rpc-api-gateway:3001/api"
  USERS_REST_URL="http://users-service-rest:3002"
  ORDERS_REST_URL="http://orders-service-rest:3004"
  USERS_RPC_ADDR="users-service-rpc:5013"
  ORDERS_RPC_ADDR="orders-service-rpc:5015"
  SUDO=""
fi
