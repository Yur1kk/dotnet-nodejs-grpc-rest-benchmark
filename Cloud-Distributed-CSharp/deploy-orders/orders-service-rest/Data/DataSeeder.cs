...
public static class DataSeeder
{
    ...
    {
        var schema = db.Model.GetDefaultSchema() ?? "orders_rest_cs";
    ...
    public static async Task ResetAsync(AppDbContext db, ILogger logger)
    {
        ...
        await db.Database.ExecuteSqlRawAsync($"TRUNCATE TABLE \"{schema}\".orders RESTART IDENTITY CASCADE;");
